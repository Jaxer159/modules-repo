...
class LydiaMod(loader.Module):
    ...
    strings = {"name": "Lydia anti-PM",
               ...
               "notif_off": "<b>Уведомления из ЛС заглушены.</b>",
               "notif_on": "<b>Уведомления из ЛС активны.</b>",
               "doc_notif": "Логическое значение для уведомлений из ЛС.",
