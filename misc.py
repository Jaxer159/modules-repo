...
class MiscMod(loader.Module):
    ...
    def __init__(self):
        self.config = mc("VOLTE_TEXT", "Если быть честным, вы должны иметь очень высокий IQ, чтобы понять VoLTE. "
                         ...
                         + "поддерживают Voltes.\n\n@Dead_Lucifffer", "", "HUAWEI_TEXT", "Знаете ли вы, что такое huawei, держу пари, "
    ...
    async def voltecmd(self, message):
        """Используйте, когда VoLTE не работает."""
    ...
    async def huaweicmd(self, message):
        """Используйте, когда ваша страна "инвестирует" в модемы Huawei 5G"""
